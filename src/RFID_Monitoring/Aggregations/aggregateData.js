...
const aggregateDataForChart = (data, startDate, endDate) => {
    let aggregatedData = [];
    let axisX_Labels = [];
...
const aggregateDataForMonitoring = data => {
...
const aggregateData = (data, startDate, endDate) => {
    const { aggregatedData, axisX_Labels} = aggregateDataForChart(data, startDate, endDate);
    const { programStatus, deviceStatus } = aggregateDataForMonitoring(data);
    Chart.SetData(aggregatedData, axisX_Labels);
    Monitoring.SetData(programStatus, deviceStatus);
};
